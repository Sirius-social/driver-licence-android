...
import com.sirius.driverlicense.databinding.DocumentsShareFragmentBinding
...
class DocumentShareFragment : BaseFragment<DocumentsShareFragmentBinding, DocumentShareViewModel>() {

    companion object {
        fun newInstance(item: ItemContacts? = null): DocumentShareFragment {
            val args = Bundle()
            args.putSerializable("item", item)
            val fragment = DocumentShareFragment()
    ...
    override fun getLayoutRes(): Int {
        return R.layout.documents_share_fragment
    }
